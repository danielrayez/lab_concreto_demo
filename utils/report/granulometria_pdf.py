...
def granulometria_pdf(muestra: str, tipo_agregado: str, df_resultados: pd.DataFrame, fig) -> bytes:
	buffer = BytesIO()
	...
	tabla_encabezado = Table(
		[
			...
			["Obra:", "Proyecto Vía Principal - Tramo A"],
			["Desarrollado por:", "Equipo Técnico Lab Concreto"],
		],
		colWidths=[140, 360],
	)
